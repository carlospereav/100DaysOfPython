...
## Config PhotoImage
import os
ruta_absoluta_pdf = os.path.abspath("images/pdf.png")
ruta_absoluta_audio = os.path.abspath("images/audio.png")
logo_image1 = PhotoImage(file=ruta_absoluta_pdf)
logo_image2 = PhotoImage(file=ruta_absoluta_audio)
...
languages['values']=('English', 'Spanish')
languages.current(0)
